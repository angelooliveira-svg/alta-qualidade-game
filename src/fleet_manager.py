...
class FleetManager:
    ...
    def check_ship_collision(self) -> None:
        """Verifica se a nave colidiu com algum alienígena."""
        # CORREÇÃO: Renomeado de _check_ship_collision para check_ship_collision
        # para bater com a chamada feita no método _update_aliens
