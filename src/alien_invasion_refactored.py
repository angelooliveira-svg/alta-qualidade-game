...
class AlienInvasion:
    ...
    def run_game(self) -> None:
        """Cria um laço de repetição para a tela sempre ficar visível até que o usuário devida fechar a janela."""
...
# CORREÇÃO: Removidos os espaços extras. Agora o bloco inicia na margem esquerda.
